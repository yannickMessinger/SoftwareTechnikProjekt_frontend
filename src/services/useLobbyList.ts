...
function joinMessage() {
  if (stompClient && (userId.value !== undefined) && (activeLobby.value.lobbyId !== undefined)) {
...
function receiveLobbyUpdates() {
  ...
  stompClient.onWebSocketError = (error) => {console.log("error", error.message)}
  stompClient.onStompError = (frame) => { console.log("error", frame.body)}
