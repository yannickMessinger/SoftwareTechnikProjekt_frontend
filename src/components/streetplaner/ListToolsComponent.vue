...
<template>
    ...
    <div id="editor-tool">
        <button class="editor-tool-btn" :style="{ backgroundImage: `url(${pedestrianInput.texture})` }" @click="togglePopup()"/>
        <p v-if="pedestrianInput != null" :style="{textAlign: `center`}">{{pedestrianInput.name}}</p>
    </div>
